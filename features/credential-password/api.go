...
// API is the public interface for the credential-password feature.
...
// Use returns a type-safe API for the credential-password feature.
...
func Use(a *aegis.Aegis) API {
	return aegis.Use[API](a, aegis.FeatureCredentialPassword)
}
