...
func (p *credentialPasswordFeature) validateUsername(username string) error {
...
func (p *credentialPasswordFeature) validateUser(user *aegis.User, additionalFields map[string]any) error {
	if user.Email == "" {
