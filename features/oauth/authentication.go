...
func (o *oauthFeature) getProviderConfig(provider Provider) (*oauth2.Config, []oauth2.AuthCodeOption) {
...
func (o *oauthFeature) constructProviderRedirectURL(provider Provider, config *oauth2.Config) string {
...
func (o *oauthFeature) GetAuthorizationURL(ctx context.Context, providerName string, request *OAuthAuthorizeURLData) (string, string, error) {
...
func (o *oauthFeature) ExchangeAuthorizationCodeForTokens(ctx context.Context, provider Provider, state, cookieNonce, code string) (*TokenResponse, map[string]any, error) {
...
func (o *oauthFeature) GetUserInfoWithTokens(ctx context.Context, provider Provider, token *TokenResponse) (*aegis.OAuthAccountProfile, error) {
...
func (o *oauthFeature) HandleOAuthCallback(ctx context.Context, providerName, code, state, cookieNonce string) (*aegis.OAuthAccountProfile, map[string]any, error) {
	provider, ok := o.providers[providerName]
	if !ok {
...
func (o *oauthFeature) AuthenticateWithProvider(ctx context.Context, providerName, code, state, cookieNonce string) (*aegis.AuthenticationResult, map[string]any, error) {
