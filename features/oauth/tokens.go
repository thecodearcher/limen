...
// expiry, and scope.
func (o *oauthFeature) GetAccessToken(ctx context.Context, userID any, providerName string) (*ActiveTokens, error) {
...
func (o *oauthFeature) RefreshAccessToken(ctx context.Context, userID any, providerName string) (*ActiveTokens, error) {
...
func (o *oauthFeature) refreshProviderToken(ctx context.Context, provider Provider, refreshToken string) (*TokenResponse, error) {
