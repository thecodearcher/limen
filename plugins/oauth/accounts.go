...
func (o *oauthPlugin) ListAccountsForUser(ctx context.Context, userID any) ([]*aegis.Account, error) {
...
func (o *oauthPlugin) UnlinkAccount(ctx context.Context, user *aegis.User, providerName string) error {
